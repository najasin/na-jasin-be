...
public class JwtProvider {
	private static final Long ACCESS_TOKEN_VALIDATION_SECOND = 60L * 60 * 24 * 1000 * 90; // 24hours
	private static final Long REFRESH_TOKEN_VALIDATION_SECOND = 60L * 60 * 24 * 1000 * 120; // 7days
